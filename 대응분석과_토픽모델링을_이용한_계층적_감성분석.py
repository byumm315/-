...
import pandas as pd
dict_0 = pd.read_excel('/content/drive/MyDrive/Bing 번역 최종.xlsx')
dict_0.head()
...
drive.mount('/content/drive')
import pandas as pd
article_0 = pd.read_excel('/content/drive/MyDrive/총선 기사 추출.xlsx')
article_0.head()
...
article_0.to_csv('총선_감성분석_졸업논문.csv',index=False)
...
drive.mount('/content/drive')
import pandas as pd
article_0 = pd.read_excel('/content/drive/MyDrive/개천절집회 기사 추출.xlsx')
article_0.head()
...
drive.mount('/content/drive')
import pandas as pd
article_0 = pd.read_excel('/content/drive/MyDrive/방역 기사 추출.xlsx')
article_0.head()
...
article_0['Score']=article_1['Score'].groupby(article_1['Index']).sum()
article_0.to_csv('방역기사_감성분석_졸업논문.csv',index=False)
...
link_3.to_csv('방역기사_토픽모델링_졸업논문.csv',index=False)